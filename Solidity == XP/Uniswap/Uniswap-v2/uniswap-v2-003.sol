...
contract UniswapV2Liquidity {
    ...
    function addLiquidity(
        ...
        (uint wethAmount, uint daiAmount, uint liquidity) = router.addLiquidity(WETH, DAI, wethAmountDesired, daiAmountDesired, 1, 1, msg.sender, block.timestamp);
    ...
    function removeLiquidity(uint liquidity) external {
       ...
       router.removeLiquidity(WETH, DAI, liquidity, 1, 1, msg.sender, block.timestamp);
    }
}